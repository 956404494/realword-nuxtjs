...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./pages/editor/index.vue?vue&type=template&id=687efa7a&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"editor-page"},[_vm._ssrNode("<div class=\"container page\"><div class=\"row\"><div class=\"col-md-10 offset-md-1 col-xs-12\"><div class=\"list-error\"><ul ng-show=\"$ctrl.errors\" class=\"error-messages\">"+(_vm._ssrList((_vm.errs),function(messages,name){return ("<div class=\"ng-scope\">"+(_vm._ssrList((messages),function(message){return ("<li class=\"ng-binding ng-scope\">"+_vm._ssrEscape("\n                "+_vm._s(name)+" "+_vm._s(message)+"\n              ")+"</li>")}))+"</div>")}))+"</ul></div> <form><fieldset><fieldset class=\"form-group\"><input type=\"text\" placeholder=\"Article Title\""+(_vm._ssrAttr("value",(_vm.article.title)))+" class=\"form-control form-control-lg\"></fieldset> <fieldset class=\"form-group\"><input type=\"text\" placeholder=\"What's this article about?\""+(_vm._ssrAttr("value",(_vm.article.description)))+" class=\"form-control\"></fieldset> <fieldset class=\"form-group\"><textarea rows=\"8\" placeholder=\"Write your article (in markdown)\" class=\"form-control\">"+_vm._ssrEscape(_vm._s(_vm.article.body))+"</textarea></fieldset> <fieldset class=\"form-group\"><input type=\"text\" placeholder=\"Enter tags\""+(_vm._ssrAttr("value",(_vm.tagText)))+" class=\"form-control\"> <div class=\"tag-list\">"+(_vm._ssrList((_vm.article.tagList),function(tag){return ("<span class=\"tag-default tag-pill ng-binding ng-scope\"><i class=\"ion-close-round\"></i>"+_vm._ssrEscape("\n                  "+_vm._s(tag)+"\n                ")+"</span>")}))+"</div></fieldset> <button type=\"submit\" class=\"btn btn-lg pull-xs-right btn-primary\">\n              Publish Article\n            </button></fieldset></form></div></div></div>")])}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/editor/index.vue?vue&type=template&id=687efa7a&
...
/* harmony default export */ var editorvue_type_script_lang_js_ = ({
  ...
  async asyncData({
    ...
    let result = params.slug ? await Object(api_article["g" /* getArticle */])(params.slug) : {};
    const {
      article
  ...
  methods: {
    ...
    async onSubmit() {
      const postArticle = this.slug ? api_article["k" /* updateArticle */] : api_article["c" /* createArticle */];

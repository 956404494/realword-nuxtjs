...
/* harmony default export */ __webpack_exports__["a"] = (({
  ...
  request.interceptors.request.use(function (config) {
    ...
    // 请求就会经过这里
    // 此处不能使用import导入store获取token 这样获取的user永远是null
    // 因此使用nuxt中的插件获取处理后的store
    const {
      user
    } = store.state;
...
const actions = {
  ...
  nuxtServerInit({
    ...
    if (req.headers.cookie) {
      ...
      const parsed = cookieparser.parse(req.headers.cookie); // 测试格式是否正确
...
const _2d69335f = () => interopDefault(__webpack_require__.e(/* import() */ 7).then(__webpack_require__.bind(null, 31)));

const _3ae9b654 = () => interopDefault(__webpack_require__.e(/* import() */ 4).then(__webpack_require__.bind(null, 30)));

const _22855c94 = () => interopDefault(__webpack_require__.e(/* import() */ 5).then(__webpack_require__.bind(null, 32)));

const _6fc75814 = () => interopDefault(__webpack_require__.e(/* import() */ 2).then(__webpack_require__.bind(null, 33)));

const _1a63bb18 = () => interopDefault(__webpack_require__.e(/* import() */ 6).then(__webpack_require__.bind(null, 34)));

const _219a59a2 = () => interopDefault(__webpack_require__.e(/* import() */ 3).then(__webpack_require__.bind(null, 35)));

const _56919b61 = () => interopDefault(__webpack_require__.e(/* import() */ 1).then(__webpack_require__.bind(null, 29))); // TODO: remove in Nuxt 3
